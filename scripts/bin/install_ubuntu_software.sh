...
# network
apt-get -y install ansible autossh axel corkscrew curl fping iptraf mtr net-tools network-manager-openvpn-gnome nmap ntp openvpn syncthing ufw whois
...
# system
apt-get -y install acpi apt-transport-https aptitude fish htop iotop mc neovim p7zip-full p7zip-rar powertop scrot snapd sshpass stow tmux tree unrar
